...
/**
 * Created by fanzhang on 2017/11/1. 1. url 2. defaultImage 3. loadingImage 4.
 * 圆角：topLeftRadius、topRightRadius、bottomLeftRadius、bottomRightRadius 5. 圆形 6.
 * fadeInMillis 渐显 7. gif 自动播放 8. listener 9. Postprocessor 后处理
 */
