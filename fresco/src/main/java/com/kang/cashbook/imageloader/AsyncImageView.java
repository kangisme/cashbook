...
public class AsyncImageView extends SimpleDraweeView implements ControllerListener<ImageInfo>
{
    ...
    private ScalingUtils.ScaleType getDraweeScaleType(ImageView.ScaleType scaleType)
    {
    ...
    public void setGifResource(String url, OnLoadingCompleteListener listener)
    {
        setImageUrl(url, -1, listener);
    }
     ...
     * {@link com.facebook.drawee.interfaces.DraweeHierarchy} 包含了展示信息：圆角、默认图等等
     * 2. {@link DraweeController} 包含了控制的逻辑：请求的链接、是否允许直接播放gif等等
     */
