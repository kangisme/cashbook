...
public class ShadeView extends View
{
    ...
    public ShadeView(Context context, AttributeSet attrs)
    {
        ...
        int textSize = (int) typedArray.getDimension(R.styleable.ShadeView_text_size, TypedValue.applyDimension(
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        int bitmapSide = Math.min(getMeasuredWidth() - getPaddingLeft() - getPaddingRight(),
